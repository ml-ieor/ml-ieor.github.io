...
$$
\max_{u}  \sum_{s,a} u(s,a)r(s,a)  \nonumber
$$
$$
\text{s.t.} \sum_{s,a} u(s,a) = p_0(s) + \sum_{s',a} \gamma P_a(s,s')u(s',a) \hspace{5mm} \forall s \in \mathcal{S} \nonumber
$$
$$
u(s,a) \geq 0 \hspace{5mm} \forall s \in \mathcal{S}, a \in \mathcal{A}
$$
